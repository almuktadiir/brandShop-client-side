...
import img2 from '../../../assets/offer.jpg'

const TrustedPartner = () => {
    return (
        <section className=" dark:text-gray-100 mb-20">
            <div className="container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
                <div>
                    <h2 className="text-3xl font-bold font-montez text-center sm:text-5xl dark:text-gray-50">Get Offers</h2>
                </div>
                <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center shadow-2xl p-5 rounded-lg ">
                    <div>
                        <h3 className="text-2xl font-bold font-montez sm:text-3xl dark:text-gray-50">Get 32% on Levis</h3>
                ...
                <div>
                    <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center shadow-2xl p-5 rounded-lg">
                        <div className="lg:col-start-2">
                            <h3 className="text-2xl font-bold font-montez italic  sm:text-3xl dark:text-gray-50">Get 20% on ZARA</h3>
